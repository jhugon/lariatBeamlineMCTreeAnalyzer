...
if __name__ == "__main__":
  ...
  plotManyHistsOnePlot(fileConfigs,histConfigs,c,"EventTree_Spill1",nMax=NMAX,outPrefix="BeamlineCuts_pz_pip")

  histConfigs = [
    {
      'preliminaryString':"e^{+} Only",
      'title': "No Cuts ~ High Yield Tracks",
      'xtitle': "True p_{z} at WC4 [MeV/c]",
      'ytitle': "Particles / bin",
      'binning': [200,0,2000],
    ...
    },
    {
      ...
      'binning': [200,0,2000],
      'var': "PzDet4",
      'cuts': "1"+highYieldTracks+"*(PDGidDet4==-11)",
      #'normalize': True,
      'logy': logy,
    },
    {
      ...
      'binning': [200,0,2000],
      'var': "PzDet4",
      'cuts': "1"+pickyTracks+"*(PDGidDet4==-11)",
      #'normalize': True,
      'logy': logy,
    },
    {
  ...
  for i in range(len(histConfigs)):
    histConfigs[i]["color"] = COLORLIST[i]
  plotManyHistsOnePlot(fileConfigs,histConfigs,c,"EventTree_Spill1",nMax=NMAX,outPrefix="BeamlineCuts_pz_ep")
  ...
  histConfigs = [
    ...
    },
    {
      ...
      'binning': [200,0,2000],
      'var': "PzDet4",
      'cuts': "1"+pickyTracks+goodTOF+notPiPEMuK,
      #'normalize': True,
      'logy': logy,
      'stack':True,
    },
  ...
  for i in range(len(histConfigs)):
    histConfigs[i]["color"] = COLORLIST[i]
  plotManyHistsOnePlot(fileConfigs,histConfigs,c,"EventTree_Spill1",nMax=NMAX,outPrefix="BeamlineComp_p_")
