...
// Mon Jul 17 10:30:38 2017 by ROOT version 5.34/23
// from TTree EventTree_Spill1/EventTree_Spill1
// found on file: /lariat/data/users/gpulliam/MCdata/64Gev_pos100A/MergedTreeRoundX_1.root
//////////////////////////////////////////////////////////
...
#ifdef TreeCutter_cxx
TreeCutter::TreeCutter(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/lariat/data/users/gpulliam/MCdata/64GeV_pos100A/RoundX.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/lariat/data/users/gpulliam/MCdata/64GeV_pos100A/RoundX.root");
      }
...
Int_t TreeCutter::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TreeCutter::LoadTree(Long64_t entry)
{
...
void TreeCutter::Init(TTree *tree)
{
...
void TreeCutter::Show(Long64_t entry)
{
...
Int_t TreeCutter::Cut(Long64_t entry)
{
